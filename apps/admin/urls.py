...
urlpatterns = [
    ...
    url(r'^view/nprojects/$', views.view_all_nprojects, name='view_all_non-financial_projects'),
    url(r'^view/nprojects_ben/(?P<user_name>.+)/$', views.view_benefactor_nprojects, name='view_benefactor_non-financial_projects'),
    url(r'^view/nprojects_org/(?P<user_name>.+)/$', views.view_organization_nprojects, name='view_organization_non-financial_projects'),
    ...
    url(r'^manage/feedback/edit/(?P<feedback_id>.+)/$', views.edit_feedback, name='feedback_authentication'),
